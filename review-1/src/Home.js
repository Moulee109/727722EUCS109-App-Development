...
// import img6 from './Assets/barcode.jpeg';
// import img7 from './Assets/user-management.jpg'; 
// import img8 from './Assets/customer-support.jpg';
      ...
      <div className="home">
        ...
        <section id="features" className="gallery">
          ...
          <div className="gallery-images">
            ...
            {/* <div className="gallery-item">
              <img src={img6} alt="Barcode Integration" />
              <p>Barcode Integration</p>
            </div>
            <div className="gallery-item">
              <img src={img7} alt="User Management" />
              <p>User Management</p>
            </div>
            <div className="gallery-item">
              <img src={img8} alt="Customer Support" />
